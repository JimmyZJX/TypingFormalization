...
\bruno{works on impredicative type inference are still missing}.
...
several modern functional languages, including Haskell, PureScript~\cite{} and
Unison~\bruno{Add references. Here is the one for unison\url{http://unisonweb.org}} among others.
...
to adapt the idea or worklist judgments with
