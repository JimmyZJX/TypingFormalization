...
Now the existential variable $\al$, being introduced before but remains unsolved,
...
\jimmy{An example on subtyping: $\nil\vdash (1\to 1)\to 1 \le (\forall a. 1 \to 1) \to 1$
...
prevent overlapping with Rules 19, 20 and 21,
which are further discussed in the last part of this section.
...
\paragraph{Design Variant for Rule 21}
