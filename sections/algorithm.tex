...
In comparison,
DK's original algorithmic subsumption rule have no restriction on the expression $e$,
...
is by combining the inferenced type of the lambda function with the subsumption rule.
...
to the reminder of the judgment chain $\jg$.
