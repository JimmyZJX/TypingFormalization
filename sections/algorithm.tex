...
several novelties.\bruno{fill in/summarize novelties}
...
\bruno{Is the discussion that follows in the right place? We just to
...
Thirdly, Rules 12-17 are base cases where an existential variable is solved.
