...
Finally, we show that our algorithm terminates:
...
\bruno{Comment about correspondence between small and big step should
  probably come here.}
...
\jimmy{Discuss briefly on the difference of encodings in the script and this paper.}
While the algorithmic rules are in a small-step style,
the proof script rewrites them into big-step style,
where inductions are more strightforward to handle.
...
\centering\begin{tabular}{|c|c|c|l|}\hline
    ...
    trans.thm           &  628 & 53  & \makecell[l]{Worklist instantiation and declarative transfer\\
    ...
    inst\_decidable.thm &  830 & 42  & Other worklist measures; Lemma~\ref{lemma:inst:decidable}\\\hline
    decidability.thm    &  885 & 50  & Termination theorem and decidability corollary\\\hline
    \hline\emph{Total}               & 7700 & 567 & (51 definitions in total)\\\hline
\end{tabular}
