...
\end{enumerate}
\end{corollary}
\bruno{if possible double-check against the corresponding Abella ones.}
...
\end{enumerate}
\end{corollary}
\bruno{We discussed the form of the lemmas on slack. Please have the first premise
  be a declarative judgement.
  If possible also double-check against Abella.}
...
\centering\begin{tabular}{|c|c|c|l|}\hline
    ...
    inst\_decidable.thm &  830 & 42  & Lemma~\ref{lemma:inst:decidable}\\\hline
