...
Nested universal quantifiers are allowed in types,
but monotypes $\tau$ do not contain any universal quantifier.
Contexts $\Psi$ are just sequences of type variable declarations.
