...
\documentclass[acmsmall]{acmart}\settopmatter{printfolios=false,printccs=false,printacmref=false}
%\renewcommand\footnotetextcopyrightpermission[0]{} % removes footnote with conference information in first column
